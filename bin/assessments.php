...
$fields = ["family","scientificName","analysis","assessment","category","criteria"];
fputcsv($csv,$fields);
...
foreach($taxons as $taxon) {
  $data=[
    $taxon["family"],$taxon["name"],$taxon["analysis"],$taxon["assessment"],$taxon["category"],$taxon["criteria"]
  ];
  fputcsv($csv,$data);
}
